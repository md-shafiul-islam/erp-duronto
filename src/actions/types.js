...
export const SET_PENDING_RECHARGES = "SET_PENDING_RECHARGES";
export const SET_RECHARGE_USING_ID = "SET_RECHARGE_USING_ID";
export const APPROVE_RECHARGE = "APPROVE_RECHARGE";

export const SET_APPROVED_RECHARGES = "SET_APPROVED_RECHARGES";
export const SET_REJECT_RECHARGE = "SET_REJECT_RECHARGE";
...
export const GET_MARITAL_STATUS_OPTIONS_ERROR =
